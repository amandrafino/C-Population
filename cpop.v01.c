...
// Func get valid population size f/user
...
// Func calculate number of years for population growth
...
int main() {
    ...
    int start_size = getPopulationSize("Enter starting population size: ", 9);

    // Get ending population size f/user
    int end_size = getPopulationSize("Enter ending population size: ", start_size);

    // Calculate number of required years
